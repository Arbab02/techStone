      ...
      <div className="container mx-auto flex  px-8 py-2 md:flex-row flex-col items-center">
        ...
        >
          ...
          >
            ...
            TailwindCSS
            <a href="/addTopic">
              <button className="block mx-auto lg:mx-0  xl:mx-0 md:mx-0 rounded-full xl:text-xl lg:text-lg text-base  bg-gradient-to-tl from-blue-700 via-[#000828] to-blue-800 font-normal mt-4 text-white px-6 py-2 md:px-7 md:py-3  transition-all hover:scale-110 ">
                Join Our Courses
              </button>
            </a>
          </motion.p>
