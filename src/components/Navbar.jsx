...
const navRef = useRef(null);
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 0) {
        navRef.current.style.backgroundColor = "#000925"; // Change navbar background
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex-shrink-0">
            <a href="#" className="flex items-center">
             <p className='text-blue-500 text-4xl font-bold'> <span className='text-white'>Tech</span>Stone</p>
            </a>
          </div>
          ...
          <div className="hidden md:flex space-x-8 mx-auto">
            ...
            <a href="/contact" className="text-white font-normal text-lg hover:text-indigo-300">Team</a>
            <a href="/contact" className="text-white font-normal text-lg hover:text-indigo-300">Events</a>
